...
model_path = hf_hub_download(repo_id="agarvish/tourism-project-prediction-model", filename="best_tourism_project_prediction_model_v1.joblib") # Updated model repo ID
